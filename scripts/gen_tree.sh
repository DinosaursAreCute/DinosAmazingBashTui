...
#
# Usage:
#   scripts/gen_tree.sh              # print bin/ and config/ trees
#   scripts/gen_tree.sh bin config   # same, explicit
#   scripts/gen_tree.sh some/dir     # tree any other directory
#
...
targets=("$@")
[[ ${#targets[@]} -eq 0 ]] && targets=(bin config)
