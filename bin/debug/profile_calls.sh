...
#   bin/debug/profile_calls.sh [-n ITERATIONS] 'COMMAND ARGS' ['COMMAND ARGS' ...]
#   bin/debug/profile_calls.sh 'tui.output p "hello"' 'tui.class p panel' 'tui.bind.table'
