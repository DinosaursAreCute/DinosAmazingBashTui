...
More: [CSV chart examples](https://github.com/DinosaursAreCute/DinosAmazingBashTui/blob/main/examples/csv-charts/README.md) · the rest of the API: [API index](README.md) · the raw escape helpers underneath: [terminal-controls.md](terminal-controls.md).
