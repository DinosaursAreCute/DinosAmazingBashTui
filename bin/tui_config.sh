...
# File: ${XDG_CONFIG_HOME:-~/.config}/${TUI_APP_NAME:-dabt}/dabt.conf  (key=value lines). tui.init applies:
...
declare -gA _TUI_CFG=()
declare -g  TUI_CONFIG_FILE="${TUI_CONFIG_FILE:-${XDG_CONFIG_HOME:-$HOME/.config}/${TUI_APP_NAME:-dabt}/dabt.conf}"
