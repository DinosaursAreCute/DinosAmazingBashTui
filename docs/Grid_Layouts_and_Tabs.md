...
from the tag reference in `docs/ui_markup.md`.
...
`docs/Bending-The-Planet-To-Your-Will_...md` for why that path is the way
it is.
...
content-fit checker (`strict_fit="false"`, see `docs/ui_markup.md`). A tab
...
(`docs/ui_markup.md`) is that something: it fires once a page's static
...
(`docs/ui_markup.md`) is the piece underneath both of them: auto-id
